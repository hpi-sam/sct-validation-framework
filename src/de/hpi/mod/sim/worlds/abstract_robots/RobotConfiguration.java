...
public class RobotConfiguration extends GridConfiguration {
    ...
    public static final String STRING_PATH_TO_LEFT_CLICKED_AREA_HIGHLIGHT = "res/robot-left-blocking.png";
    public static final String STRING_PATH_TO_RIGHT_CLICKED_AREA_HIGHLIGHT = "res/robot-right-blocking.png";
    ...
    private static String stringPathToLeftClickedAreaHighlight = STRING_PATH_TO_LEFT_CLICKED_AREA_HIGHLIGHT;
    private static String stringPathToRightClickedAreaHighlight = STRING_PATH_TO_RIGHT_CLICKED_AREA_HIGHLIGHT;
	...
	public static String getStringPathToLeftClickedAreaHighlight() {
		return stringPathToLeftClickedAreaHighlight;
	}

	public static String getStringPathToRightClickedAreaHighlight() {
		return stringPathToRightClickedAreaHighlight;
	}
