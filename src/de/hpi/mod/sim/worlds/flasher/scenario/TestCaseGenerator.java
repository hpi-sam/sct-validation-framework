...
public class TestCaseGenerator {
    ...
    private static List<TestScenario> generateTests(FlashWorld world) {
        ...
        TaskProviderSpecification starter = new TaskProviderSpecification(Arrays.asList(new FlashTask(0, 10000)), false, world);
        ...
        TaskProviderSpecification starter2 = new TaskProviderSpecification(Arrays.asList(new FlashTask(1, 10000)), false, world);
        ...
        TaskProviderSpecification starter3 = new TaskProviderSpecification(Arrays.asList(new FlashTask(1, 10000)), false, world);
        ...
        TaskProviderSpecification starter4 = new TaskProviderSpecification(Arrays.asList(new FlashTask(2, 10000)), false, world);
        testScenarios.add(
        ...
        TaskProviderSpecification starter5 = new TaskProviderSpecification(Arrays.asList(new FlashTask(5, 10000)), false, world);
        ...
        TaskProviderSpecification starter6 = new TaskProviderSpecification(Arrays.asList(new FlashTask(2, 10000)), false, world);
        ...
        TaskProviderSpecification starter7 = new TaskProviderSpecification(Arrays.asList(new FlashTask(0, 10000)), false, world);
        ...
        TaskProviderSpecification starter8 = new TaskProviderSpecification(Arrays.asList(new FlashTask(2, 2000), new FlashTask(4, 4000), new FlashTask(1, 2000)), false, world);
