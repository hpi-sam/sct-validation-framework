...
//	}
	...
	private List<TestScenario> generateCompleteDriveRoutineTests() {
		List<TestScenario> testScenarios = new ArrayList<>();
		List<RobotDescription> newRobots;
        ...
        newRobots.add(new TestRobotDescription(new Position(2, 0), RobotState.TO_LOADING, Orientation.NORTH, targetsRobotOne, true));
        newRobots.add(new TestRobotDescription(new Position(2, -1), RobotState.TO_QUEUE, Orientation.NORTH, targetsRobotTwo, true));
		testScenarios.add(new ConcreteTestScenario ("Two robots unload", "Two robots driving close to each other to similar unloading positions.", newRobots));
        ...
        newRobots.add(new TestRobotDescription(new Position(2, 0), RobotState.TO_LOADING, Orientation.NORTH, targetsRobotOne, true));
        newRobots.add(new TestRobotDescription(new Position(2, -1), RobotState.TO_QUEUE, Orientation.NORTH, targetsRobotTwo, true));
        newRobots.add(new TestRobotDescription(new Position(2, -2), RobotState.TO_QUEUE, Orientation.NORTH, targetsRobotThree, true));
        testScenarios.add(new ConcreteTestScenario ("Three robots unload", "Three robots driving close to each other to similar unloading positions.", newRobots));
        ...
        newRobots.add(new TestRobotDescription(new Position(2, 0), RobotState.TO_LOADING, Orientation.NORTH, targets, true));
        testScenarios.add(new ConcreteTestScenario("Medium long route", "A single robot has a sequence of targets to cover.", newRobots));
        ...
        newRobots.add(new TestRobotDescription(new Position(2, 0), RobotState.TO_LOADING, Orientation.NORTH, targets, true));
        testScenarios.add(new ConcreteTestScenario("Long route", "A single robot has a long sequence of targets to cover.", newRobots));
    ...
    private List<RobotDescription> r_list(RobotDescription... r){
    	return new ArrayList<RobotDescription>(Arrays.asList(r));
    }
	...
	private List<TestScenario> generateTwoRobotsOnCrossroadTests() {
        ...
        newRobots.add(new TestRobotDescription(new Position(-3+biasX*3, 8+biasY*3), RobotState.TO_UNLOADING, Orientation.WEST, targetsRobotOne,0,1000));
        newRobots.add(new TestRobotDescription(new Position(-6+biasX*3, 7+biasY*3), RobotState.TO_UNLOADING, Orientation.EAST, targetsRobotThree,0,1000));
        ...
        newRobots.add(new TestRobotDescription(new Position(-5+biasX*3, 9+biasY*3), RobotState.TO_UNLOADING, Orientation.SOUTH, targetsRobotOne,0,1000));
        newRobots.add(new TestRobotDescription(new Position(-4+biasX*3, 6+biasY*3), RobotState.TO_UNLOADING, Orientation.NORTH, targetsRobotThree,0,1000));
        ...
        newRobots.add(new TestRobotDescription(new Position(-4+3*biasX, 6+3*biasY), RobotState.TO_UNLOADING, Orientation.NORTH, targetsRobotTwo,0,1000));
        newRobots.add(new TestRobotDescription(new Position(-6+3*biasX, 7+3*biasY), RobotState.TO_UNLOADING, Orientation.EAST, targetsRobotThree,0,1000));
        ...
        targetsRobotThree = new ArrayList<>();
        targetsRobotThree.add(new Position(-3+3*biasX,7+3*biasY));
        newRobots.add(new TestRobotDescription(new Position(-5+3*biasX, 9+3*biasY), RobotState.TO_UNLOADING, Orientation.SOUTH, targetsRobotOne,0,1000));
        newRobots.add(new TestRobotDescription(new Position(-6+3*biasX, 7+3*biasY), RobotState.TO_UNLOADING, Orientation.EAST, targetsRobotThree,0,1000));
        ...
        newRobots.add(new TestRobotDescription(new Position(-3+3*biasX, 8+3*biasY), RobotState.TO_UNLOADING, Orientation.WEST, targetsRobotOne,0,1000));
        newRobots.add(new TestRobotDescription(new Position(-5+3*biasX, 9+3*biasY), RobotState.TO_UNLOADING, Orientation.SOUTH, targetsRobotTwo,0,1000));
	...
	private List<TestScenario> generateThreeRobotsOnCrossroadTests() {
        ...
        newRobots.add(new TestRobotDescription(new Position(-4+3*biasX, 6+3*biasY), RobotState.TO_UNLOADING, Orientation.NORTH, targetsRobotTwo,0,1000));
        newRobots.add(new TestRobotDescription(new Position(-6+3*biasX, 7+3*biasY), RobotState.TO_UNLOADING, Orientation.EAST, targetsRobotThree,0,1000));
        testScenarios.add(new ConcreteTestScenario("Three Robots 1", "Three Robots must pass a croassroad without collision. (Version 1)", newRobots));
        ...
        newRobots.add(new TestRobotDescription(new Position(-4+3*biasX, 6+3*biasY), RobotState.TO_UNLOADING, Orientation.NORTH, targetsRobotTwo,0,1000));
        newRobots.add(new TestRobotDescription(new Position(-6+3*biasX, 7+3*biasY), RobotState.TO_UNLOADING, Orientation.EAST, targetsRobotThree,0,1000));
        testScenarios.add(new ConcreteTestScenario("Three Robots 2", "Three Robots must pass a croassroad without collision. (Version 2)", newRobots));
        ...
        newRobots.add(new TestRobotDescription(new Position(-5+3*biasX, 9+3*biasY), RobotState.TO_UNLOADING, Orientation.SOUTH, targetsRobotTwo,0,1000));
        newRobots.add(new TestRobotDescription(new Position(-6+3*biasX, 7+3*biasY), RobotState.TO_UNLOADING, Orientation.EAST, targetsRobotThree,0,1000));
        testScenarios.add(new ConcreteTestScenario("Three Robots 3", "Three Robots must pass a croassroad without collision. (Version 3)", newRobots));
        ...
        newRobots.add(new TestRobotDescription(new Position(-3+3*biasX, 8+3*biasY), RobotState.TO_UNLOADING, Orientation.WEST, targetsRobotOne,0,1000));
        newRobots.add(new TestRobotDescription(new Position(-4+3*biasX, 6+3*biasY), RobotState.TO_UNLOADING, Orientation.NORTH, targetsRobotTwo,0,1000));
        newRobots.add(new TestRobotDescription(new Position(-5+3*biasX, 9+3*biasY), RobotState.TO_UNLOADING, Orientation.SOUTH, targetsRobotThree,0,1000));
        testScenarios.add(new ConcreteTestScenario("Three Robots 4", "Three Robots must pass a croassroad without collision. (Version 4)", newRobots));
	...
	private List<TestScenario> generateFourRobotsOnCrossroadTest() {
         ...
         newRobots.add(new TestRobotDescription(new Position(6, 5), RobotState.TO_UNLOADING, Orientation.WEST, targetsRobotOne));
         newRobots.add(new TestRobotDescription(new Position(5, 3), RobotState.TO_UNLOADING, Orientation.NORTH, targetsRobotTwo));
         newRobots.add(new TestRobotDescription(new Position(3, 4), RobotState.TO_UNLOADING, Orientation.EAST, targetsRobotThree));
         newRobots.add(new TestRobotDescription(new Position(4, 6), RobotState.TO_UNLOADING, Orientation.SOUTH, targetsRobotFour));
         testScenarios.add(new ConcreteTestScenario("Four Robots", "Four Robots must pass a croassroad without collision.", newRobots));
	...
	private class ConcreteTestScenario extends TestScenario {
        ...
        public ConcreteTestScenario(String name, String description, List<RobotDescription> robots) {
            this.name = name;
