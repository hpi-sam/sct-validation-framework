<<<<<<< HEAD:simulator/src-gen/de/hpi/mod/sim/Paddle1.java
...
public class Paddle1 implements IStatemachine {
	public enum State {
		PONG_IDLE_STOP,
		PONG_MOVING_UP,
		PONG_MOVIN_DOWN,
	...
	*/
	...
	private boolean check_pong__choice_0_tr0_tr0() {
		return (operationCallback.myPos()>((getBallPosValue() + 10)) && operationCallback.myPos()>getMinPos());
	}
	
	private boolean check_pong__choice_0_tr1_tr1() {
		return (operationCallback.myPos()<((getBallPosValue() - 10)) && operationCallback.myPos()<getMaxPos());
	}
...
>>>>>>> 308c2f6b59a427da313ecd842c5fe5e5918e5f8c:simulator/src-gen/de/hpi/mod/sim/Paddle1.java
