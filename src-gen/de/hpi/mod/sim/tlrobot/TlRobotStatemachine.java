...
public class TlRobotStatemachine implements ITlRobotStatemachine {
	...
	public enum State {
		...
		tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1,
		tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2,
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case tlRobot_driving__driving_waiting_on_trafficlight:
				...
				break;
			case tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1:
				tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1_react(true);
				break;
			case tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2:
				tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2_react(true);
				break;
	...
	*/
	public boolean isStateActive(State state) {
		...
		case tlRobot_driving__driving_leaving_crossroad_ahead:
			return stateVector[0].ordinal() >= State.
					tlRobot_driving__driving_leaving_crossroad_ahead.ordinal()&& stateVector[0].ordinal() <= State.tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2.ordinal();
		case tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1:
			return stateVector[0] == State.tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1;
		case tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2:
			return stateVector[0] == State.tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2;
	...
	private boolean check_tlRobot_driving__driving__choice_3_tr2_tr2() {
	...
	private void entryAction_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1() {
		sCIActors.raiseDriveForward();
	}
	
	/* Entry action for state 'forward2'. */
	private void entryAction_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2() {
		sCIActors.raiseDriveForward();
	}
	...
	private void enterSequence_tlRobot_driving__driving_leaving_crossroad_ahead_default() {
		enterSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_default();
	}
	
	/* 'default' enter sequence for state forward1 */
	private void enterSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1_default() {
		entryAction_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1();
		nextStateIndex = 0;
		stateVector[0] = State.tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1;
	}
	
	/* 'default' enter sequence for state forward2 */
	private void enterSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2_default() {
		entryAction_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2();
		nextStateIndex = 0;
		stateVector[0] = State.tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2;
	}
	...
	private void enterSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_default() {
		react_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward__entry_Default();
	}
	...
	private void exitSequence_tlRobot_driving__driving_leaving_crossroad_ahead() {
		exitSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward();
	}
	
	/* Default exit sequence for state forward1 */
	private void exitSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	
	/* Default exit sequence for state forward2 */
	private void exitSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private void exitSequence_tlRobot() {
		...
		case tlRobot_driving__driving_waiting_on_trafficlight:
			...
			break;
		case tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1:
			exitSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1();
			break;
		case tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2:
			exitSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2();
			break;
		case tlRobot_driving__driving_leaving_crossroad_to_right_side__onCrossroadDriveRight_right:
	...
	private void exitSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward() {
		switch (stateVector[0]) {
		case tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1:
			exitSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1();
			break;
	...
	private void react_tlRobot_driving__driving__choice_3() {
		if (check_tlRobot_driving__driving__choice_3_tr0_tr0()) {
			...
			if (check_tlRobot_driving__driving__choice_3_tr1_tr1()) {
				...
				if (check_tlRobot_driving__driving__choice_3_tr2_tr2()) {
	...
	/* Default react sequence for initial entry  */
	private void react_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward__entry_Default() {
		enterSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1_default();
	}
	...
	private void react_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward__exit_Default() {
	...
	private boolean tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1_react(boolean try_transition) {
		boolean did_transition = try_transition;
		
		if (try_transition) {
			if (sCInterface.actionCompleted) {
				exitSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward1();
				enterSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2_default();
	...
	private boolean tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2_react(boolean try_transition) {
		boolean did_transition = try_transition;
		
		if (try_transition) {
			if (sCInterface.actionCompleted) {
				exitSequence_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward_forward2();
				react_tlRobot_driving__driving_leaving_crossroad_ahead__onCrossroadDriveForward__exit_Default();
			} else {
				did_transition = false;
			}
		}
