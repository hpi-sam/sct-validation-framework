...
public class GridManagerTest {
    ...
    public void cellType() {
        ...
        assertEquals(CellType.CHARGER, grid.cellType(new Position(0, -1)));
        assertEquals(CellType.CHARGER, grid.cellType(new Position(0, -2)));
        assertEquals(CellType.CHARGER, grid.cellType(new Position(0, -3)));
        assertEquals(CellType.CHARGER, grid.cellType(new Position(3, -3)));
        assertEquals(CellType.CHARGER, grid.cellType(new Position(-3, -3)));
...
//
//        // Drive out of Charger to Loading -> East
